...
const GameLobby = ({
    ...
    return (
        <div className="w-full max-w-md mx-auto bg-slate-800/50 backdrop-blur-xl rounded-2xl shadow-2xl p-6 text-white animate-fade-in border border-slate-700 flex flex-col h-[90vh]">
            {/* بخش پروفایل کاربر که همیشه ثابت است */}
            {userData && (
                <div className="relative flex items-center gap-4 bg-black/20 p-1 rounded-xl mb-6">
                    <img
                        src={
                            userData.photo_url
            ...
            {/* بخش محتوای متغیر که بر اساس تب فعال تغییر می‌کند */}
            <div className="flex-grow overflow-y-auto">
                {/* شرط: اگر تب "بازی" فعال بود این بخش نمایش داده می‌شود */}
                {activeTab === "play" && (
                    <>
                ...
                {/* شرط: اگر تب "دوستان" فعال بود این بخش نمایش داده می‌شود */}
                {activeTab === "friends" && (
            ...
            {/* نوار جابجایی بین تب‌ها در پایین */}
            <div className="flex justify-around items-center border-t border-slate-700 pt-4 mt-4">
                <button
                    onClick={() => setActiveTab("play")}
                    className={`w-1/2 text-center font-bold transition-colors ${
                        activeTab === "play"
                            ? "text-blue-400"
            ...
            {/* مودال دعوت دوستان که دست نخورده باقی می‌ماند */}
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50 animate-fade-in">
                    ...
                    <div className="bg-gray-800 bg-opacity-90 rounded-xl p-6 w-full max-w-sm">
                        ...
                        <ol className="list-decimal list-inside text-gray-400 mb-4 space-y-2">
                            ...
                                         {" "}
                            <li>
                                When they join and play, you will get some
                                rewards!
                            </li>
                                               {" "}
                        </ol>
